        ...
        <div className="mx-auto max-w-md">
          <div className="mb-6">
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-300">
              Sign in to sync your favorites and weekly plans across devices.
            </p>
          </div>
          ...
          <div className="glass rounded-xl p-6">
            ...
            <p className="mt-4 text-center text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link to="/signup" className="font-semibold text-fuchsia-600 hover:underline dark:text-fuchsia-300">
                Sign up
              </Link>
            </p>
          </div>
