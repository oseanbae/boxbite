  ...
  return (
    <section className="pt-10">
        ...
        <div className="glass mb-6 flex items-center gap-4 rounded-xl p-4">
          <label className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-200">
            <input
              ...
              className="h-4 w-4 rounded border-slate-300 bg-white text-fuchsia-500 focus:ring-fuchsia-400 dark:border-white/20 dark:bg-slate-900"
            />
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-12 text-center text-slate-700 dark:border-white/5 dark:bg-slate-900/70 dark:text-slate-200">
